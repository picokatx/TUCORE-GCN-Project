...
class BaseBertEmbeddings(nn.Module):
    ...
    input_embeds: pass embeddings directly to model, overwrites input_ids
    past_key_values_length: If position ids is not passed, initializes them from previous input
    """
    def forward(
        self,
