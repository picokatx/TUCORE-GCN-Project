...
class TUCOREGCN_BERT(nn.Module):
    def __init__(self, config, num_labels, gcn_layers=2, activation='relu', gcn_dropout=0.6):
        ...
        rel_name_lists = ['speaker', 'dialog', 'entity'] # entity: object node as defined in paper
    ...
    """
    def forward(self, input_ids, token_type_ids, attention_mask, speaker_ids, graphs, mention_id, labels=None, turn_mask=None):
        """
        Encoder Module
        """
