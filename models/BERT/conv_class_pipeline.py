"""
Stolen from Conversational Pipeline
"""
import uuid
from typing import Any, Dict, List, Union

from transformers.utils import add_end_docstrings, is_tf_available, is_torch_available, logging
...
class Message:
    def __init__(self, dialogue: str, speaker: str, speaker_uuid: uuid.UUID = None):
